...
z_K_anal = imag(y(complex(K,h),C))/h;
z_C_anal = imag(y(K,complex(C,h)))/h;
...
figure(1)
plot(t, z_K_anal, '-k', t, y_K,'--c', t, z_K_finite, 'r*', 'linewidth',3)
set(gca,'Fontsize',22);
xlabel('Time')
ylabel('z_K')
...
figure(2)
plot(t, z_C_anal, '-k', t, y_C,'--c', t, z_C_finite, 'r*', 'linewidth',3)
set(gca,'Fontsize',22);
xlabel('Time')
ylabel('z_C')
legend('Complex Step','Analytic','Finite Difference','Location','NorthEast') 
